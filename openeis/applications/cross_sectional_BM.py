...
class Application(DriverApplicationBaseClass):
    ...
    def get_config_parameters(cls):
        #Called by UI
        return {
                    "building_sq_ft": ConfigDescriptor(float, "Square footage", minimum=5000),
                    "building_year_constructed": ConfigDescriptor(int, "Construction Year", minimum=1800, maximum=2014),
    ...
    def execute(self):
        ...
        if PMMetrics == None: 
            ...
            self.out.insert_row('CrossSectionalBM', {'Metric Name': 'Year',\
                                                     'Value': recent_record[0]})
            self.out.insert_row('CrossSectionalBM', {'Metric Name': 'Target Finder Median Score',\
                                                     'Value': str(PMMetrics['medianScore'][0])})
            self.out.insert_row('CrossSectionalBM', {'Metric Name': 'Target Finder Score',\
