...
angular.module("openeis-ui.auth",["ngResource","ngRoute"]).config(["$routeProvider",function(a){a.when("/",{controller:"LoginCtrl",templateUrl:"/partials/login.html"})}]).factory("Auth",["$resource","API_URL","$q",function(a,b,c){var d=this;return d.authenticated=null,d.resource=a(b+"/auth"),d.isAuthenticated=function(){var a=c.defer();return null===d.authenticated?d.resource.get().$promise.then(function(){d.authenticated=!0,a.resolve()},function(b){d.authenticated=!1,a.reject(b)}):d.authenticated===!1?a.reject({status:403}):d.authenticated===!0&&a.resolve(),a.promise},d.logIn=function(a){var b=c.defer();return d.resource.save(a).$promise.then(function(){d.authenticated=!0,b.resolve()},function(a){b.reject(a)}),b.promise},d.logOut=function(){var a=c.defer();return d.resource.delete().$promise.then(function(){d.authenticated=!1,a.resolve()},function(b){a.reject(b)}),a.promise},d}]).controller("LoginCtrl",["$scope","$location","Auth","AUTH_HOME",function(a,b,c,d){a.form={},a.form.logIn=function(){c.logIn({username:a.form.username,password:a.form.password}).then(function(){b.url(d)},function(b){switch(b.status){case 403:a.form.error="Authentication failed.";break;default:a.form.error="Unknown error occurred."}})}}]).controller("TopBarCtrl",["$scope","Auth","$location","ANON_HOME",function(a,b,c,d){a.logOut=function(){b.logOut().then(function(){c.url(d)})}}]),angular.module("openeis-ui",["openeis-ui.auth","openeis-ui.projects","ngAnimate","ngRoute"]).constant("API_URL","/api").constant("ANON_HOME","/").constant("AUTH_HOME","/projects").config(["$routeProvider","$locationProvider","$httpProvider",function(a,b,c){a.otherwise({templateUrl:"/partials/404.html"}),b.html5Mode(!0),c.defaults.xsrfHeaderName="X-CSRFToken",c.defaults.xsrfCookieName="csrftoken"}]),angular.module("openeis-ui.projects",["openeis-ui.auth","ngResource","ngRoute","mm.foundation"]).config(["$routeProvider",function(a){a.when("/projects",{controller:"ProjectsCtrl",templateUrl:"/partials/projects.html",resolve:{projects:["Projects",function(a){return a.query()}]}}).when("/projects/:projectId",{controller:"ProjectCtrl",templateUrl:"/partials/project.html",resolve:{project:["Projects","$route",function(a,b){return a.get(b.current.params.projectId)}]}})}]).factory("Projects",["$resource","API_URL",function(a,b){var c={resource:a(b+"/projects/:projectId",{projectId:"@id"}),get:function(a){return c.resource.get({projectId:a}).$promise},query:function(){return c.resource.query().$promise}};return c}]).controller("ProjectsCtrl",["$scope","projects",function(a,b){a.projects=b}]).controller("ProjectCtrl",["$scope","project","$modal",function(a,b,c){a.project=b,a.open=function(){var a=c.open({templateUrl:"/partials/addfile.html",controller:"AddFileCtrl"});a.result.then(function(a){console.log(a)},function(a){console.log(a)})}}]).controller("AddFileCtrl",["$scope","$modalInstance",function(a,b){a.ok=function(){b.close("Clicked OK.")},a.cancel=function(){b.dismiss("Cancelled.")}}]);
/*
